...
void periph_motor_init(void)
{
	...
	stepmotor_set_config(motor_left_handle, leftmotor_cfg);
	stepmotor_config(motor_left_handle);
	...
	stepmotor_set_config(motor_right_handle, rightmotor_cfg);
	stepmotor_config(motor_right_handle);
...
void periph_motor_left_stop(void)
{
	...
	stepmotor_stop(motor_left_handle);
}
...
void periph_motor_right_stop(void)
{
	...
	stepmotor_stop(motor_right_handle);
}
...
void periph_encoder_init(void)
{
	...
	encoder_set_config(encoder_left_handle, left_encoder_cfg);
	encoder_config(encoder_left_handle);
	...
	encoder_set_config(encoder_right_handle, right_encoder_cfg);
	encoder_config(encoder_right_handle);
